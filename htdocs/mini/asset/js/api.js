...
//   var response
//   var url=webroot+appname+'/asset/json/usbcommand-mini/'+ pretype +'.json'
...
//原点だし
function req_usb_command(pretype, param0) {
  //台車ロック原点設定 param0 : 昇降原点位置の設定（0:－ / 1:実施） ※0はスキップ
  //台車ロック操作 param0 : 昇降ステート（0:解錠 [昇降Down] / 1:施錠 [昇降Up]）
  var url=webroot+appname+'/asset/json/usbcommand-mini/'+ pretype +'.json'
  //console.log(url)
  $.getJSON(url, (res) => {
    //console.log(res)
