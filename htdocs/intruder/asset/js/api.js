...
function req_move(destination) {
  ...
  if (tolerance.destinations == null || tolerance.destinations == '') {
    initTorelanceList() 
  }
  if (tolerance.destinations[destination] != null) {
    tolerancenum = parseInt(tolerance.destinations[destination])/1000
  }
  data = {
    "type":"req_move",
    "data": {
