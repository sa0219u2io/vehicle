...
<!-- メニューの描画 -->
<div class="modal hid modal_message" id="modal-modal_message">
</div>
...
<div class="modal hid" id="modal-turnaround">
  ...
  <div class="modalhelp">現在地と選択した目的地の間を<br>
...
<div class="modal hid" id="modal-order">
  ...
  <div class="modalhelp">
    目的地の並べ替えが可能です。<br>設定がなければ地図で作成された順番となります。<br>登録を終えたらメニューから目的地選択画面を再度選びなおしてください。
  </div>
</div>
<!-- 各画面アナウンス設定 -->
...
<div class="modal hid" id="modal-reserve">
  ...
  <div class="modalcontent">
    ...
    <div class="flexbox">
      <div class="inbox"><p data-target="reserve-hour" data-touch="-1" data-hold ="-5" class="number-alter" data-min="1" data-max="22">◀</p></div>
      <div class="inbox"><div id="reserve-hour" data=""></div></div>時
      <div class="inbox"><p data-target="reserve-hour" data-touch="1" data-hold ="5" class="number-alter" data-min="1" data-max="22">▶</p></div>
      <div class="inbox"><p data-target="reserve-minute" data-touch="-1" data-hold ="-5" class="number-alter" data-min="1" data-max="58">◀</p></div>
...
<!-- 複数稼働設定モード設定 -->
<div class="modal hid" id="modal-multiple">
  <div class="modalcontent">
    <div class="modaltitle">複数台稼働設定</div>
    <div class="modalsubtitle">自己ロボットIP</div>
    <div id="multiplemyip" class="modalchild"></div>
    <div class="modalsubtitle">対象ロボットIPリスト</div>
    <div id="multipleiplist" class="modalchild"></div>
    <div class="modalsubtitle">回避拠点リスト</div>
    <div id="multiplehublist" class="modalchild"></div>
    <div class="modalsubtitle">自動復帰適用外拠点リスト</div>
    <div id="multipleexceptionlist" class="modalchild"></div>
  </div>
  <button class="modal-button" id="set-multiple">セット</button>
  <button class="modal-button" id="clear-multiple">解除</button>
  <div class="modalhelp">この設定をONにすると、複数台のロボットが地図を共有し、目的地が被ったり、すでに目的地にロボットがいたりする場合に、回避拠点に向かうようになります。回避拠点にいるロボットは、目的地があくと、本来の目的地に戻ります。回避拠点にいる間に別の目的地移動を指示されると、この移動はキャンセルされます</div>
</div>
<!-- 第二段階目モーダル -->
...
<!-- 情報パネル -->
 <!-- メニューの描画 -->
<div class="panel hid" id="panel-info">
  <?php foreach(INFOLIST as $key => $value):?>
    <div clas="flexbox">
      <div class="inbox">[<?=$value?>]</div>
      <div class="inbox panel-info" id="info-<?=$key?>"></div>
    </div><hr>
  <?php endforeach?>
</div>