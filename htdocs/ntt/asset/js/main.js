...
const variablefilename = 'ntt_variable.json'
...
const mainversion = appname + '1.4.1' + '('+debug+')'
...
function move(destination) {
  ...
  // setTimeout(function(){req_move(destination)}, 1500)
  setTimeout(function(){req_move_qbit(destination)}, 500)
  loadBall()
}
